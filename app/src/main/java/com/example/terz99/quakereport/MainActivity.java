...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Earthquake>>{
    ...
    private final static String URL = "https://earthquake.usgs.gov/fdsnws/event/1/query";
    ...
    public Loader<ArrayList<Earthquake>> onCreateLoader(int id, Bundle args) {
        ...
        // Get the value of the preference with the given key in type of String object
    ...
    /**
     * This method creates an settings menu
     * @param menu is the menu which is inflated
     * @return true
     */
    @Override
    ...
    /**
     * This method opens the menu fragment when the button is clicked
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // Get the id of the item in the menu clicked
        ...
        // Otherwise return super class method
